...
i_t_dc, i_amp_dc = dcsource._get_data()
i_t_noise, i_amp_noise = noise._get_data()
i_t_step, i_amp_step = step._get_data()
...
if '--plot-figure' in sys.argv:
    ...
    plt.subplot(2,1,2)
    plt.plot(i_t_ac, i_amp_ac, 'r')
    plt.plot(i_t_dc, i_amp_dc, 'b')
    plt.plot(i_t_noise, i_amp_noise, 'g')
